 ...
 */
object FingerTree {
  sealed trait FingerTree[@specialized(Int, Long, Float, Double, Char) +A] {
    def isEmpty: Boolean
    ...
    def +:[/* @specialized(Int, Long, Float, Double, Char) */ B >: A](b: B): FingerTree[B]
    def +[/* @specialized(Int, Long, Float, Double, Char) */ B >: A](b: B): FingerTree[B]
  ...
  final case class Single[@specialized(Int, Long, Float, Double, Char) +A](a: A) extends FingerTree[A] {
    val headLeft = a
    val tailLeft = Empty
    ...
    def +:[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = Deep(One(b), Empty, One(a))

    def +[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = Deep(One(a), Empty, One(b))
  ...
  final case class Deep[@specialized(Int, Long, Float, Double, Char) +A](prefix: Digit[A],
    ...
    def +:[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = prefix match {
      case Four(d, e, f, g) => Deep(Two(b, d), Node3(d, e, f) +: tree, suffix)
      case partial => Deep(b :: partial, tree, suffix)
    }

    def +[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = suffix match {
...
//            case FTNilRight() => prefix.toTree   // this match crashes Scalac 2.9.1 -- thus use the wildcard instead
  ...
  case object Empty extends FingerTree[Nothing] {
    ...
    def +:[@specialized(Int, Long, Float, Double, Char) A](a: A) = Single(a)
  ...
  sealed trait Node[@specialized(Int, Long, Float, Double, Char) +A] {
    def toDigit: Digit[A]
    def toList: List[A]
  }

  final case class Node2[@specialized(Int, Long, Float, Double, Char) +A](a1: A, a2: A) extends Node[A] {
  ...
  final case class Node3[@specialized(Int, Long, Float, Double, Char) +A](a1: A, a2: A, a3: A)
    extends Node[A] {
  ...
  sealed trait FTViewLeft[+S[+_], /* @specialized(Int, Long, Float, Double, Char) */ +A] {
    def head: A
    def tail: S[A]
  }

  final case class FTConsLeft[+S[+_], /* @specialized(Int, Long, Float, Double, Char) */ +A](head: A, tail: S[A])
    extends FTViewLeft[S, A]
  ...
  sealed trait FTViewRight[+S[+_], /* @specialized(Int, Long, Float, Double, Char) */ +A] {
    def tail: S[A]
    def head: A
  }

  final case class FTConsRight[+S[+_], /* @specialized(Int, Long, Float, Double, Char) */ +A](tail: S[A], head: A)
    extends FTViewRight[S, A]
  ...
  sealed trait Digit[/* @specialized(Int, Long, Float, Double, Char) */ +A] {
    def headLeft: A
    ...
    def ::[/* @specialized(Int, Long, Float, Double, Char) */ B >: A](b: B): Digit[B]
    def +[/* @specialized(Int, Long, Float, Double, Char) */ B >: A](b: B): Digit[B]
  ...
  final case class One[@specialized(Int, Long, Float, Double, Char) +A](a1: A) extends Digit[A] {
    val headLeft = a1
    ...
    def ::[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = Two(b, a1)
    def +[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = Two(a1, b)
  ...
  final case class Two[@specialized(Int, Long, Float, Double, Char) +A](a1: A, a2: A) extends Digit[A] {
    val headLeft = a1
    def tailLeft = One(a2)
    ...
    def ::[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = Three(b, a1, a2)
    def +[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = Three(a1, a2, b)
  ...
  final case class Three[@specialized(Int, Long, Float, Double, Char) +A](a1: A, a2: A, a3: A)
    extends Digit[A] {
    ...
    def ::[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = Four(b, a1, a2, a3)
    def +[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) = Four(a1, a2, a3, b)
  ...
  final case class Four[@specialized(Int, Long, Float, Double, Char) +A](a1: A, a2: A, a3: A, a4: A)
    extends Digit[A] {
    ...
    def ::[@specialized(Int, Long, Float, Double, Char) B >: A](b: B) =
      throw new UnsupportedOperationException(":: on Four")
